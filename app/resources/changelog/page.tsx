...
export default function ChangelogPage() {
  return (
    <article className="doc-prose">
      ...
      <ul>
        <li><strong>Rebranded to &ldquo;ACKO Design Standards&rdquo;</strong> — renamed from &ldquo;Visual Standards&rdquo; across all pages, navigation, and metadata.</li>
        <li><strong>About ACKO page redesign</strong> — updated heading to &ldquo;What should every ACKO experience feel like?&rdquo; and replaced all tile icons with ACKO icons from R2 bucket.</li>
        ...
        <li><strong>Removed eyebrow labels</strong> — eliminated &ldquo;FOUNDATION / ABOUT ACKO / DESIGN SYSTEM&rdquo; chips from all page headers for cleaner presentation.</li>
